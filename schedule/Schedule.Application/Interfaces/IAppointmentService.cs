...
namespace Schedule.Application.Interfaces
{
    public interface IAppointmentService
    {
        ...
        Task<AppointmentsResponseDto> ScheduleAsync(AppointmentCreateDto dto, CancellationToken ct=default);
        Task<IEnumerable<AppointmentsResponseDto>> GetConsultationsByProfessionalAsync(Guid id, CancellationToken ct = default);
    }
}
