...
namespace Schedule.Application.Dtos.Healthcares
{
    public static class HealthcareDto
    {
        ...
        public record HealthcareUpdateDto(Guid Id, string? Name, string? Email, string? CRM, string? Speciality, string? Password);
        public record HealthcareResponseDto(Guid Id, string Name, string Email, string CRM, string Speciality);
        public record HealthcareSchedulesResponseDto(Guid Id, string Name, string Email, string CRM, string Speciality, List<AppointmentsResponseDto> Schedulles);
